	...
	public void startScrape(String url) throws Exception {
		...
		for(Element element : elements.select("div.zg_itemImmersion")) {				
			for(Element subelement1 : element.select("div.zg_itemWrapper")) {
				...
				printwrite.println(new Date().toString()+";"+itemName+";"+itemRating+";"+itemPrice+";"+itemReviewTimes+";"+itemPrime);
				System.out.println(new Date().toString()+";"+itemName+";"+itemRating+";"+itemPrice+";"+itemReviewTimes+";"+itemPrime);
